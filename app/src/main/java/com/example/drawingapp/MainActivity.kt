...
class MainActivity : AppCompatActivity() {
    ...
    private val gallerylauncher: ActivityResultLauncher<Intent> =
            registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
                if (result.resultCode == RESULT_OK && result.data != null) {
                    val backImage: ImageView = findViewById<ImageButton>(R.id.iv_background)
                    backImage.setImageURI(result.data?.data)
                }
            ...
            registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()){
                ...
                permissions.entries.forEach {
                    ...
                    if(isGranted){
                        Toast.makeText(
                            this@MainActivity,
                            "Permission Now Granted", Toast.LENGTH_LONG
                        ).show()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val ll = findViewById<LinearLayout>(R.id.ll_paint_colors)
        val dv = findViewById<DrawingView>(R.id.drawing_view)
        val br = findViewById<ImageButton>(R.id.ib_brush)
        val gl = findViewById<ImageButton>(R.id.ib_gallery)
        val mUndo = findViewById<ImageButton>(R.id.ib_undo)
        val saveb = findViewById<ImageButton>(R.id.ib_save)
        dv.setSizeForBrush(20.toFloat())
        mImageButtonCurrentPaint = ll[1] as ImageButton
    ...
    private fun requestStoragePermission(){
        if(ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            showRationalDialog("DrawingApp", "Drawing App"+"Needs access to your External Storage.")
        }else{
